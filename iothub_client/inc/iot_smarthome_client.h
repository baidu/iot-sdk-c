...
// OTA functions
MOCKABLE_FUNCTION(, void, iot_smarthome_client_ota_register_pull_job, const IOT_SH_CLIENT_HANDLE, handle, SHADOW_OTA_JOB_CALLBACK, callback, void*, callbackContext);
...
MOCKABLE_FUNCTION(, int, iot_smarthome_client_ota_pull_job, const IOT_SH_CLIENT_HANDLE, handle, const char*, device, const char*, firmwareVersion, const char*, requestId);
