...
MOCKABLE_FUNCTION(, int, iot_smarthome_client_ota_get_job, const IOT_SH_CLIENT_HANDLE, handle, const char*, device,
                    const char*, firmwareVersion, const char*, requestId);
MOCKABLE_FUNCTION(, int, iot_smarthome_client_ota_report_result, const IOT_SH_CLIENT_HANDLE, handle, const char*, device, const char*, jobId, const char*, firmwareVersion, const char*, requestId);

MOCKABLE_FUNCTION(, int, iot_smarthome_client_ota_get_subdevice_job, const IOT_SH_CLIENT_HANDLE, handle, const char*,
                    gateway, const char*, subdevice, const char*, firmwareVersion, const char*, requestId);
