...
static inline void * xxx_tls_malloc(unsigned nmemb, unsigned size)
{
	return xxx_calloc(nmemb*size);	
}
...
#define MBEDTLS_PLATFORM_CALLOC_MACRO xxx_tls_malloc //mbedtls_calloc //
...
#define MBEDTLS_SSL_MAX_CONTENT_LEN         (512*12) /**< Size of the input / output buffer */
