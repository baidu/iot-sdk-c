...
static inline void * dna_tls_malloc(unsigned nmemb, unsigned size)
{
	return dna_calloc(nmemb*size);	
}
...
#define MBEDTLS_PLATFORM_CALLOC_MACRO dna_tls_malloc //mbedtls_calloc //
