...
{
	printf("00000destroy mbedtls!\r\n");
    if (tls_io != NULL)
    {
	printf("11111-1destroy mbedtls!\r\n");
        ...
        if (strcmp(OPTION_TRUSTED_CERT, optionName) == 0)
        {
            ...
            else
            {
                ...
                if (parse_result != 0)
                {
                	...
                	LogInfo("%x %d %s\r\n",parse_result,__LINE__,__func__);
